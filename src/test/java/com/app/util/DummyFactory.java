...
public class DummyFactory {
    ...
    public static ISistema crearSistema(){
        ...
        rutas.add(new DtRuta("Montevideo-Buenos Aires", "Ruta entre Montevideo y Buenos Aires", "Montevideo a Buenos Aires", LocalTime.of(2, 0).toString(), 150, 300, 20, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(1)), ciudades.get(0), ciudades.get(1),0));
        rutas.add(new DtRuta("Buenos Aires-Santiago", "Ruta entre Buenos Aires y Santiago", "Buenos Aires a Santiago", LocalTime.of(3, 0).toString(), 200, 400, 25, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(1)), ciudades.get(1), ciudades.get(2),0));
        rutas.add(new DtRuta("Santiago-Lima", "Ruta entre Santiago y Lima", "Santiago a Lima", LocalTime.of(4, 0).toString(), 220, 450, 30, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(2), categorias.get(3)), ciudades.get(2), ciudades.get(3),0));
        rutas.add(new DtRuta("Lima-São Paulo", "Ruta entre Lima y São Paulo", "Lima a São Paulo", LocalTime.of(5, 0).toString(), 250, 500, 35, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(4)), ciudades.get(3), ciudades.get(4),0));
        rutas.add(new DtRuta("São Paulo-Rio de Janeiro", "Ruta entre São Paulo y Rio de Janeiro", "São Paulo a Rio", LocalTime.of(1, 30).toString(), 120, 240, 15, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(1), categorias.get(3)), ciudades.get(4), ciudades.get(5),0));
        rutas.add(new DtRuta("Rio de Janeiro-Asunción", "Ruta entre Rio de Janeiro y Asunción", "Rio a Asunción", LocalTime.of(4, 30).toString(), 280, 560, 40, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(2)), ciudades.get(5), ciudades.get(6),0));
        rutas.add(new DtRuta("Asunción-Montevideo Norte", "Ruta entre Asunción y Montevideo Norte", "Asunción a Montevideo Norte", LocalTime.of(3, 15).toString(), 210, 420, 25, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(3)), ciudades.get(6), ciudades.get(7),0));
        rutas.add(new DtRuta("Montevideo Norte-Quito", "Ruta entre Montevideo Norte y Quito", "Montevideo Norte a Quito", LocalTime.of(6, 0).toString(), 300, 600, 45, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(1), categorias.get(4)), ciudades.get(7), ciudades.get(8),0));
        rutas.add(new DtRuta("Quito-Bogotá", "Ruta entre Quito y Bogotá", "Quito a Bogotá", LocalTime.of(2, 45).toString(), 180, 360, 20, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0)), ciudades.get(8), ciudades.get(9),0));
        rutas.add(new DtRuta("Bogotá-Montevideo", "Ruta entre Bogotá y Montevideo", "Bogotá a Montevideo", LocalTime.of(7, 0).toString(), 350, 700, 50, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(2), categorias.get(4)), ciudades.get(9), ciudades.get(0),0));
        rutas.add(new DtRuta("Montevideo-Lima", "Ruta entre Montevideo y Lima", "Montevideo a Lima", LocalTime.of(5, 0).toString(), 260, 520, 30, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(1)), ciudades.get(0), ciudades.get(3),0));
        rutas.add(new DtRuta("Buenos Aires-Rio de Janeiro", "Ruta entre Buenos Aires y Rio de Janeiro", "Buenos Aires a Rio", LocalTime.of(3, 30).toString(), 230, 460, 25, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(2), categorias.get(3)), ciudades.get(1), ciudades.get(5),0));
        rutas.add(new DtRuta("Santiago-Asunción", "Ruta entre Santiago y Asunción", "Santiago a Asunción", LocalTime.of(5, 15).toString(), 270, 540, 35, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(1)), ciudades.get(2), ciudades.get(6),0));
        rutas.add(new DtRuta("Lima-Montevideo Norte", "Ruta entre Lima y Montevideo Norte", "Lima a Montevideo Norte", LocalTime.of(6, 30).toString(), 290, 580, 40, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(4)), ciudades.get(3), ciudades.get(7),0));
        rutas.add(new DtRuta("São Paulo-Quito", "Ruta entre São Paulo y Quito", "São Paulo a Quito", LocalTime.of(7, 15).toString(), 310, 620, 45, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(3)), ciudades.get(4), ciudades.get(8),0));
        rutas.add(new DtRuta("Rio de Janeiro-Bogotá", "Ruta entre Rio de Janeiro y Bogotá", "Rio a Bogotá", LocalTime.of(6, 0).toString(), 300, 600, 40, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(2), categorias.get(4)), ciudades.get(5), ciudades.get(9),0));
        rutas.add(new DtRuta("Asunción-Lima", "Ruta entre Asunción y Lima", "Asunción a Lima", LocalTime.of(5, 45).toString(), 280, 560, 35, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0)), ciudades.get(6), ciudades.get(3),0));
        rutas.add(new DtRuta("Montevideo Norte-São Paulo", "Ruta entre Montevideo Norte y São Paulo", "Montevideo Norte a São Paulo", LocalTime.of(6, 15).toString(), 300, 600, 40, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(1), categorias.get(2)), ciudades.get(7), ciudades.get(4),0));
        rutas.add(new DtRuta("Quito-Rio de Janeiro", "Ruta entre Quito y Rio de Janeiro", "Quito a Rio", LocalTime.of(7, 30).toString(), 320, 640, 50, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(3), categorias.get(4)), ciudades.get(8), ciudades.get(5),0));
        rutas.add(new DtRuta("Bogotá-Santiago", "Ruta entre Bogotá y Santiago", "Bogotá a Santiago", LocalTime.of(5, 0).toString(), 250, 500, 30, LocalDate.now().toString(), "default.png", Arrays.asList(categorias.get(0), categorias.get(2)), ciudades.get(9), ciudades.get(2),0));
