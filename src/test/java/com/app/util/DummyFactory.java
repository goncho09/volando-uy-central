...
public class DummyFactory {
    ...
    public static ISistema crearSistema(){
        ...
        rutas.add(new DtRuta("Asunción-Montevideo Norte", "Ruta entre Asunción y Montevideo Norte", "Asunción a Montevideo Norte", LocalTime.of(3, 15).toString(), 210, 420, 25, LocalDate.now().toString(), "default.png","https://www.youtube.com/watch?v=TMh9BTBQ8Yc", Arrays.asList(categorias.get(0), categorias.get(3)), ciudades.get(6), ciudades.get(7),0));
        ...
        rutas.add(new DtRuta("Quito-Bogotá", "Ruta entre Quito y Bogotá", "Quito a Bogotá", LocalTime.of(2, 45).toString(), 180, 360, 20, LocalDate.now().toString(), "default.png","https://www.youtube.com/watch?v=TMh9BTBQ8Yc", Arrays.asList(categorias.get(0)),ciudades.get(8), ciudades.get(9),0));
        ...
        rutas.add(new DtRuta("Montevideo-Lima", "Ruta entre Montevideo y Lima", "Montevideo a Lima", LocalTime.of(5, 0).toString(), 260, 520, 30, LocalDate.now().toString(), "default.png","https://www.youtube.com/watch?v=TMh9BTBQ8Yc", Arrays.asList(categorias.get(0), categorias.get(1)), ciudades.get(0), ciudades.get(3),0));
        ...
        rutas.add(new DtRuta("Asunción-Lima", "Ruta entre Asunción y Lima", "Asunción a Lima", LocalTime.of(5, 45).toString(), 280, 560, 35, LocalDate.now().toString(), "default.png","https://www.youtube.com/watch?v=TMh9BTBQ8Yc", Arrays.asList(categorias.get(0)), ciudades.get(6), ciudades.get(3),0));
        ...
        rutas.add(new DtRuta("Quito-Rio de Janeiro", "Ruta entre Quito y Rio de Janeiro", "Quito a Rio", LocalTime.of(7, 30).toString(), 320, 640, 50, LocalDate.now().toString(), "default.png","https://www.youtube.com/watch?v=TMh9BTBQ8Yc", Arrays.asList(categorias.get(3), categorias.get(4)), ciudades.get(8), ciudades.get(5),0));
